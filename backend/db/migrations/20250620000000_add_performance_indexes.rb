Sequel.migration do
  up do
    ...
    alter_table(:encrypted_files) do
      add_index [:created_at, :account_id], name: :idx_files_created_account
      add_index [:ip_address, :created_at], name: :idx_files_ip_created
    end
    
    alter_table(:accounts) do
      add_index :created_at, name: :idx_accounts_created
      add_index [:email, :password_hash], name: :idx_accounts_auth
    end
